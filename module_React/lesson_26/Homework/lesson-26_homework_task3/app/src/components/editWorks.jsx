...
class EditWorks extends React.Component {
    ...
    _handleClickOnWork(event) {
        ...
        EditWorks.turnOffOtherActiveWorks(this.refs.worksList);
    ...
    static mapStateToProps(state) {
        return {
            ...
            currentEditedWork: state.todoList.currentEditedWork,
            currentWorkInput: state.todoList.currentWorkInput
        };
    }
...
export default connect(EditWorks.mapStateToProps, EditWorks.matchDispatchToProps)(EditWorks);