...
// Note: It is difficulty to do that task by using Restify, because we cannot use template rendering and static
// files, so I assume the better idea is to use Express. However, I have done the task by using Restify.
